...
- [ADR-0021: Site-scoped automatic Signage enrollment and LAN discovery](ADR-0021-site-signage-automatic-enrollment.md) — replaces operator-synchronized projection tokens and fixed Event UUIDs with revocable installation credentials, automatic catalog synchronization, and friendly LAN discovery.
