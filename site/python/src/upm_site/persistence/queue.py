"""Site-only durable queue and transactional outbox operations."""
...
class SiteQueue:
    """Queue operations scoped exclusively to a Site database session."""
        ...
        statement = (
            ...
            .where(
                or_(
                    ...
                    and_(model.status == JobStatus.RUNNING, model.lease_expires_at < now),
                )
            )
