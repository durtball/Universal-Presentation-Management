...
public sealed class PresentationRow{public Guid PresentationId{get;set;}public Guid? PresentationVersionId{get;set;}public Guid? RoomId{get;set;}public int Revision{get;set;}public string Start{get;set;}="—";public string Room{get;set;}="—";public string Session{get;set;}="—";public string Presenter{get;set;}="—";public string Title{get;set;}="—";public string Identifier{get;set;}="—";public string Filename{get;set;}="—";public string OperationsDetail{get;set;}="—";public string Version{get;set;}="—";public string Size{get;set;}="—";public string Hash{get;set;}="—";public string ReceivedAt{get;set;}="—";public string SiteSyncState{get;set;}="UNKNOWN";public string CentralBackupState{get;set;}="UNKNOWN";public string CentralBackupError{get;set;}="";public string RoomCacheState{get;set;}="UNKNOWN";public string VersionHistory{get;set;}="";public string Status{get;set;}="UNKNOWN";public Brush StatusBrush{get;set;}=new SolidColorBrush(Colors.Gray);public string FileType{get;set;}="";}
