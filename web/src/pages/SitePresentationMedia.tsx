...
export function SitePresentationMedia() {
  ...
  useEffect(() => { if (!activeEvent) return; const timer=window.setInterval(intake.poll,3000); return () => window.clearInterval(timer); }, [activeEvent,intake.poll]);
