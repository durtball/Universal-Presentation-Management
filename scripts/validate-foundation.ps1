...
try {
    $requiredPaths = @(
        ...
        'docs/architecture/decisions/ADR-0003-postgresql-durable-jobs-and-outbox.md',
        'docs/architecture/decisions/ADR-0004-site-media-ingestion-finalization.md',
        'docs/architecture/decisions/ADR-0005-container-migration-gates.md',
        'docs/architecture/decisions/ADR-0006-central-site-registration-and-sync.md',
        'docs/deployment/README.md',
        'docs/development/durable-jobs-and-outbox.md',
        'docs/development/central-site-synchronization.md',
        ...
        'database/central/migrations/versions/ad875b02aaed_add_central_durable_jobs_and_outbox.py',
        'database/central/migrations/versions/c91a4b2d8f20_add_central_site_registry_and_sync.py',
        ...
        'database/site/migrations/versions/6ed903da8ed5_add_site_durable_jobs_and_outbox.py',
        'database/site/migrations/versions/b7c4e2a91f10_add_site_media_ingestion.py',
        'database/site/migrations/versions/d04f87a2c311_add_site_identity_and_sync.py',
        ...
        'central/python/src/upm_central/persistence/queue.py',
        'central/python/src/upm_central/worker.py',
        'site/python/pyproject.toml',
        'site/python/src/upm_site/api.py',
        'site/python/src/upm_site/persistence/models.py',
        'site/python/src/upm_site/persistence/queue.py',
        'site/python/src/upm_site/media/ingestion.py',
        'site/python/src/upm_site/media/cleanup.py',
        'site/python/src/upm_site/media/storage.py',
        'site/python/src/upm_site/worker.py',
        ...
        'scripts/site-media-smoke.py',
        'scripts/deploy-central-linux.sh',
        'scripts/test-compose-migrations.sh',
        'tests/python/test_compose_deployment.py',
        'tests/python/test_sync_contracts.py',
        'tests/python/test_sync_foundation_postgres.py',
