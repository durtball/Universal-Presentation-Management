"""Alembic environment for the Central database only."""
...
def database_url() -> str:
    url = os.environ.get("UPM_CENTRAL_DATABASE_URL")
    if not url:
        raise RuntimeError("UPM_CENTRAL_DATABASE_URL is required for Central migrations")
    if not url.startswith("postgresql+psycopg://"):
        raise RuntimeError("Central migrations require a postgresql+psycopg:// URL")
    return url
